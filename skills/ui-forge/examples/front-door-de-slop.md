# Front Door De-Slop Example

Use this example when a prompt asks for a public site, landing page, skill site, tool page, portfolio, or brand front door and the likely default output is a centered gradient hero with generic cards.

## Weak default

Prompt: "Create a landing page for DevForge, a conference for engineers."

Common weak result:

- centered headline: "Build the future. Together.";
- blue-purple gradient accents;
- made-up stats, ratings, testimonials, or "10x faster" claims;
- three or four equal feature cards;
- generic buttons such as "Get started" and "Learn more";
- no proof that the conference, product, or tool has a specific point of view.
