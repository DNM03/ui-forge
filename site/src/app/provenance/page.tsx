...
export default function ProvenancePage() {
  return (
    <div className="page-stack">
      <PageHeader eyebrow={`Reviewed ${manifest.provenance.reviewedAt}`} title="Provenance" description="Exact research snapshots, official standards, influence boundaries, and retained license information." />
